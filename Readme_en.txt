HTML generator with images and textHTML generator with images and textHTML generator with images and text
...
Navigation menu:
The generated HTML file includes a navigation menu that allows you to quickly access the different generated files. You can see them, copy the text.

Copy of text and images:
With just one click, you can copy the text of the generated files to the clipboard.

How to use the HTML Generator with images and text.
  Download the source code of the project. Configure the folders that contain the images and text files. Run the script to generate the HTML files. Open the generated HTML file and use the navigation menu to access the different files. Explore, copy the text.
_______________________________________________________________________________________________________________________________________________________
For the future:
Implement Gradio and improve the structure and visualization of the program.
Integrate it with Automatic 1111, improve the selection of the prompt and the image so that it can be integrated with the other tools.
...
Note: The "mini" version can be used independently in any folder, while the "txt_png_to_htmlA1111" version will be the future version with many improvements. (In development)

Enjoy an efficient and organized way to create and manage your HTML files!
contributions
Contributions are welcome! If you want to participate in the development of this project or have ideas to improve it, feel free to open an issue or submit a pull request. Your collaboration is very valuable and helps to enrich this tool for the benefit of the community
  Download the source code of the project. Configure the folders that contain the images and text files. Run the script to generate the HTML files. Open the generated HTML file and use the navigation menu to access the different files. Explore, copy the text.
_______________________________________________________________________________________________________________________________________________________
For the future:
Implement Gradio and improve the structure and visualization of the program.
